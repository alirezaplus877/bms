...
namespace PecBMS.Helper.Identity
{
    ...
    public static class Captcha
    {
        ...
        public static bool ValidateCaptchaCode(string captchaCode, string userInputCaptcha, IMemoryCache memoryCache)
        {
            try
            {
                var getcaptcha = memoryCache.Get(captchaCode);
                var isValid = userInputCaptcha == getcaptcha?.ToString();
                memoryCache.Remove(captchaCode);
                return isValid;
            }
            catch (Exception)
            {
